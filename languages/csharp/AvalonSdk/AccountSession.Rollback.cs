...
namespace Avalon.Sdk
{
    public sealed partial class AccountSession
    {
        ...
        /// Failures surface as <see cref="AvalonRequestException"/> carrying the HTTP status and the server's <c>Code</c>
        ...
        /// <see cref="AvalonRequestException"/> carrying the HTTP status and <c>Code</c> (404 not eligible,
